...
void Player::setup() {
	...
	setupLimb(spineToShoulderCenter, "image.png", 150.f, 100.f );
	setupLimb(spineToHipCenter, "image.png", 40.f, 40.f );

	setupLimb(hipCenterToHipLeft, "image.png", 50.f, 20.f );
	setupLimb(hipCenterToHipRight, "image.png", 50.f, 20.f );

	setupLimb(shoulderCenterToHead, "image.png", 40.f, 40.f );
	setupLimb(shoulderCenterToShoulderLeft, "image.png", 40.f, 20.f );
	setupLimb(shoulderCenterToShoulderRight, "image.png", 40.f, 20.f );

	setupLimb(shoulderLeftToElbowLeft, "image.png", 100.f, 20.f );
	setupLimb(elbowLeftToWristLeft, "image.png", 80.f, 20.f );
	setupLimb(wristLeftToHandLeft, "image.png", 50.f, 20.f );

	setupLimb(shoulderRightToElbowRight, "image.png", 100.f, 20.f );
	setupLimb(elbowRightToWristRight, "image.png", 80.f, 20.f );
	setupLimb(wristRightToHandRight, "image.png", 50.f, 20.f );

	setupLimb(hipLeftToKneeLeft, "image.png", 100.f, 20.f );
	setupLimb(kneeLeftToAnkleLeft, "image.png", 80.f, 20.f );
	setupLimb(ankleLeftToFootLeft, "image.png", 60.f, 20.f );

	setupLimb(hipRightToKneeRight, "image.png", 100.f, 20.f );
	setupLimb(kneeRightToAnkleRight, "image.png", 80.f, 20.f );
	setupLimb(ankleRightToFootRight, "image.png", 60.f, 20.f );
